...
public class Main {
    protected static ArrayList<PracownikBadawczoDydaktyczny> Naukowcy = new ArrayList<PracownikBadawczoDydaktyczny>();
    protected static ArrayList<PracownikAdministracyjny> Administracja = new ArrayList<PracownikAdministracyjny>();
    protected static ArrayList<Student> Studenci = new ArrayList<Student>();
    protected static ArrayList<Kurs> Kursy = new ArrayList<Kurs>();
    public static void main(String[] args) {
        ...
        ArrayList<PracownikBadawczoDydaktyczny> wyszukaniNaukowcy = new ArrayList<PracownikBadawczoDydaktyczny>();
        wyszukaniNaukowcy.addAll(szukajNaukowcow("Kurczak", "ulubione jedzenie"));

        ArrayList<PracownikAdministracyjny> wyszukaniAdministratorzy = new ArrayList<PracownikAdministracyjny>();
        wyszukaniAdministratorzy.addAll(szukajAdministracji("Specjalista", "stanowisko"));

        ArrayList<Student> wyszukaniStudenci = new ArrayList<Student>();
        wyszukaniStudenci.addAll(szukajStudentow("Fizyka 1", "kurs"));

        ArrayList<Kurs> wyszukaneKursy = new ArrayList<Kurs>();
        wyszukaneKursy.addAll(szukajKursow("Jan", "prowadzący"));
    ...
    public static ArrayList<PracownikBadawczoDydaktyczny> szukajNaukowcow(String fraza, String selektor)  {
        ArrayList<PracownikBadawczoDydaktyczny> wynik = new ArrayList<PracownikBadawczoDydaktyczny>();
        switch(selektor) {
            case "imie":
    ...
    public static ArrayList<PracownikAdministracyjny> szukajAdministracji(String fraza, String selektor) {
        ArrayList<PracownikAdministracyjny> wynik = new ArrayList<PracownikAdministracyjny>();
        switch(selektor) {
            case "imie":
    ...
    public static ArrayList<Student> szukajStudentow(String fraza, String selektor) {
        ArrayList<Student> wynik = new ArrayList<Student>();
        switch(selektor) {
            case "imie":
    ...
    public static ArrayList<Kurs> szukajKursow(String fraza, String selektor) {
        ArrayList<Kurs> wynik = new ArrayList<Kurs>();
        switch(selektor) {
            case "nazwa kursu":
                for (Kurs kurs : Kursy) {
                    if (kurs.getNazwaKursu().equals(fraza)) {
